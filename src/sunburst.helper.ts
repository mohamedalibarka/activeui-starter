import { axisIds, CellSet, CellSetSelection, Member } from "@activeviam/activeui-sdk";
...
const sunburstPointToCellSetSelection = (pluginData: CellSet, point: PlotDatum): CellSetSelection | undefined => {
